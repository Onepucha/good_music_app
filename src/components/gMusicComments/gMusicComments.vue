<template>
  <div class="g-music-comments">
      ...
      <template v-for="comment in comments" :key="comment._id">
        <q-item>
          ...
          <q-item-section side top>
            ...
            <q-item-label v-if="authStore.user">
              <div
                v-if="comment.user === authStore.user._id"
                class="g-link"
          ...
          <template v-for="reply in comment.replies" :key="reply._id">
            <q-item>
              ...
              <q-item-section side top>
                ...
                <q-item-label v-if="authStore.user">
                  <div
                    v-if="reply.user === authStore.user?._id"
                    class="g-link"
            ...
            <q-list>
              ...
              >
                ...
                <q-item-section side top>
                  ...
                  <q-item-label v-if="authStore.user">
                    <div
                      v-if="replyToReply.user === authStore.user?._id"
                      class="g-link"
                      @click.prevent="
        ...
        <q-form v-if="replyOpen[comment._id]">
          <g-input
            ...
            standout
          />
          <q-card-actions v-if="authStore.user">
            <q-btn
              :label="t('gMusicComments.buttonReplyComment')"
              :loading="isLoading"
              class="q-btn-large full-width"
    ...
    <div v-if="authStore.user" class="g-music-comments__actions">
      <g-input
