    ...
    return new Promise((resolve: any, reject: any) => {
      ...
      function getArtists() {
        return ok([
          {
            _id: '1',
            cover_src: '/images/artists/theWeeknd.png',
            name: 'The Weeknd',
            verified: true,
            follow: false,
          },
          {
            _id: '2',
            cover_src: '/images/artists/arianaGrande.png',
            name: 'Ariana Grande',
            verified: false,
            follow: false,
          },
          {
            _id: '3',
            cover_src: '/images/artists/katyPerry.png',
            name: 'Katy Perry',
            verified: true,
            follow: false,
          },
          {
            _id: '4',
            cover_src: '/images/artists/ryanJones.png',
            name: 'Ryan Jones',
            verified: true,
            follow: false,
          },
          {
            _id: '5',
            cover_src: '/images/artists/acidrap.png',
            name: 'Acidrap',
            verified: true,
            follow: false,
          },
          {
            _id: '6',
            cover_src: '/images/artists/cleanBandit.png',
            name: 'Clean Bandit',
            verified: true,
            follow: false,
          },
      ...
      function getReleases() {
        return ok([
          {
            _id: 1,
            cover_src: '/images/newReleases/aniaSzarmach.png',
            name: 'Shades of Love - Ania Szarmach',
            code: '1',
          },
          {
            _id: 2,
            cover_src: '/images/newReleases/kidLaroi.png',
            name: 'Without You - The Kid LAROI',
            code: '2',
          },
          {
            _id: 3,
            cover_src: '/images/newReleases/theWeekndAri.png',
        ...
        return ok([
          {
            _id: '1',
            position: '1',
            cover_src: '/images/albums/handsome.png',
            name: 'HANDSOME',
            artist: 'Warren Hue',
            code: '1',
            issueYear: '2022',
          },
          {
            _id: '2',
            position: '2',
            cover_src: '/images/albums/sharks.png',
            name: 'Sharks',
          ...
          },
          {
            _id: '3',
            position: '3',
            cover_src: '/images/albums/somebodysNobody.png',
          ...
          },
          {
            _id: '4',
            position: '4',
            cover_src: '/images/albums/breackMySoul.png',
            name: 'BREAK MY SOUL',
            artist: 'Beyonce',
            code: '4',
            issueYear: '2022',
          },
          {
            _id: '5',
            position: '5',
            cover_src: '/images/albums/disaster.png',
            name: 'Disaster',
            artist: 'Conan Gray',
            code: '5',
            issueYear: '2018',
